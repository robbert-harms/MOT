...
/*
  ...
  Parameters:
    ...
    Input, double A[N*N], the real symmetric input matrix.  
...
class eispack_tred2_upper_triangular(SimpleCLLibrary):
    def __init__(self):
        super().__init__('''
void eispack_tred2_upper_triangular ( int n, double* a, double* d, double* e, double* z ){
/*
  Purpose:
  ...
  Discussion:
    ...
    This version is adapted to use an upper triangular matrix as input.
  ...
  Modified:
    ...
    03 November 2012
    31 December 2018 (Robbert Harms, adapted for an upper triangular input matrix).
  ...
  Parameters:
    ...
    Input, double A[n*(n+1)/2], the upper triangle of a real symmetric input matrix. 

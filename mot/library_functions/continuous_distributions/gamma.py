...
class _find_inverse_s(SimpleCLLibrary):
    def __init__(self):
        ...
        """
        super(_find_inverse_s, self).__init__(
            'double', '_find_inverse_s',
            [('double', 'p'), ('double', 'q')],
            '''
            double s, t;
...
class _didonato_SN(SimpleCLLibrary):
    def __init__(self):
        ...
        super(_didonato_SN, self).__init__(
            'double', '_didonato_SN',
            [('double', 'a'), ('double', 'x'), ('uint', 'N'), ('double', 'tolerance')],
            '''
            double sum = 1.0;
...
class _find_inverse_gamma(SimpleCLLibrary):
    def __init__(self):
        ...
        Copied from Scipy (https://github.com/scipy/scipy/blob/master/scipy/special/cephes/igami.c), 05-05-2018.
        """
        super(_find_inverse_gamma, self).__init__(
            'double', '_find_inverse_gamma',
...
class _igami_impl(SimpleCLLibrary):
    def __init__(self):
        ...
        Copied from Scipy (https://github.com/scipy/scipy/blob/master/scipy/special/cephes/igami.c), 05-05-2018.
        """
        super(_igami_impl, self).__init__(
            'double', '_igami_impl',
            [('double', 'a'), ('double', 'p')],
            '''
            int i;
...
class _igamci_impl(SimpleCLLibrary):
    def __init__(self):
        ...
        Copied from Scipy (https://github.com/scipy/scipy/blob/master/scipy/special/cephes/igami.c), 05-05-2018.
        """
        super(_igamci_impl, self).__init__(
            'double', '_igamci_impl',
            [('double', 'a'), ('double', 'q')],
            '''
            int i;
...
class igamc_continued_fraction(SimpleCLLibrary):
    def __init__(self):
        ...
        Copied from Scipy (https://github.com/scipy/scipy/blob/master/scipy/special/cephes/igam.c), 05-05-2018.
        """
        super(igamc_continued_fraction, self).__init__(
            'double', 'igamc_continued_fraction',
            [('double', 'a'), ('double', 'x')],
            '''
            int MAXITER = 500;
...
class igam_series(SimpleCLLibrary):
    def __init__(self):
        ...
        Copied from Scipy (https://github.com/scipy/scipy/blob/master/scipy/special/cephes/igam.c), 05-05-2018.
        """
        super(igam_series, self).__init__(
            'double', 'igam_series',
            [('double', 'a'), ('double', 'x')],
            '''
            int MAXITER = 500;
...
class igam_igamc_asymptotic_series(SimpleCLLibrary):
    def __init__(self):
        ...
        """
        super(igam_igamc_asymptotic_series, self).__init__(
            'double', 'igam_igamc_asymptotic_series',
            [('double', 'a'), ('double', 'x'), ('int', 'func')],
            '''
            int IGAM = 1;
            int IGAMC = 0;

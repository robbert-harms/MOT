...
double bessel_i0(double x){
    ...
    y=3.75/fabs(x);
    return (exp(fabs(x)) / sqrt(fabs(x))) * fma(y, fma(y, fma(y, fma(y,
                                                fma(y, fma(y, fma(y, fma(y, 0.392377e-2, -0.1647633e-1), 0.2635537e-1),
                                                    -0.2057706e-1), 0.916281e-2), -0.157565e-2), 0.225319e-2),
                                                        0.1328592e-1), 0.39894228);
}

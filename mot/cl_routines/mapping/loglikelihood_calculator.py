...
class _LogLikelihoodCalculatorWorker(Worker):
    ...
    def calculate(self, range_start, range_end):
        ...
        likelihoods_buf = cl.Buffer(self._cl_environment.context,
        ...
        self._kernel.run_kernel(self._queue, (int(nmr_problems), ), None, *data_buffers)
        event = cl.enqueue_copy(self._queue, self._log_likelihoods[range_start:range_end],

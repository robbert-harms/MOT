...
UBUNTU_OTHER_TARGET_DISTRIBUTIONS=zesty
...
docs-pdf:
	...
	@echo "To view results use something like: evince docs/_build/latex/mot.pdf &"
...
docs-man:
	...
	@echo "To view results use something like: man docs/_build/man/mot.1 &"
